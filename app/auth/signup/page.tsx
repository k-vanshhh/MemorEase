...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await authAPI.signup(formData.name, formData.email, formData.password, formData.confirmPassword)
        ...
        <div className="w-full max-w-md">
          <div className="space-y-8">
            <div className="text-center space-y-2">
              ...
              <p className="text-muted-foreground">Join MemorEase and discover meaningful gifts</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center gap-2">
                <input type="checkbox" id="terms" className="w-4 h-4 rounded border-border" required />
